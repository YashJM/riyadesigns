...
export function CaseStudyImageTrigger({
  ...
  return (
    <button
      ...
      className={`block w-full cursor-zoom-in text-left transition-opacity hover:opacity-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#f387ab] focus-visible:ring-offset-2 ${className ?? ""}`}
